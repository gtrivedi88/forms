...
<form method="post" action="{{ url_for('add_product') }}">
    ...
    <fieldset class="product-alias-group">
        ...
        <button type="button" class="add-group-btn" onclick="addGroup()">Add Another Alias Group</button>
        <!-- "Delete" button for the current group -->
        <button type="button" class="remove-reference" style="display: none;" onclick="deleteGroup(this)">Delete
            Group</button>
    </fieldset>
